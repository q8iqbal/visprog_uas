...
namespace CampusApp.Controllers
{
    public class EnrollmentController : Controller
    {
        ...
        public EnrollmentController(iqbaldbContext context)
        {
            _context = context;
        }
        ...
        {
            var iqbaldbContext = _context.Enrollment.Include(e => e.Course).Include(e => e.Student);
        ...
        public async Task<IActionResult> Create([Bind("EnrollmentID,CourseID,StudentID,Status")] Enrollment enrollment)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("EnrollmentID,CourseID,StudentID,Status")] Enrollment enrollment)
        {
